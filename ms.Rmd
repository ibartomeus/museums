...
^4^ Andrena Iniciativas y Estudios Medio Ambientales
...
plot(log(lhf$post1980+1), log(lhf$pre1980+1), xlab = "post1980", ylab = "pre1980", col = col, pch = pchs)
...
#write.csv(genus_tot3, "raw_data/spain_species_per_genus.csv")
