...
One of the main barriers to identifying trends in pollinator populations is that pollinators are incredibly diverse and include bees, flies, butterflies, beetles, birds, bats and even lizards [#@Winfree2011]. All this groups of pollinators are often highly mobile, short-lived and small, difficulting the monitoring of its poplations. Bees are generally regarded as the most important pollinator group due to their abundance, pollination efficiency and widespread distribution [@Ollerton2017]. However, bees are also diverse, with more than 20,000 species currently described worldwide [#@PickeringAscher], and often require expert taxonomists for identification. Furthermore, the uneven distribution of researchers [#@Martinetal2012] has also resulted in geographical biases in bee decline research, as well as taxonomic biases toward species that are easier to identify, such as bumblebees [#@ArcherOikos, @DePalma2016]. 

One solution to overcoming these barriers has been to use space-for-time substitutions, where researchers compare pollinator populations across environmental gradients. Despite critiques on the robustness of this approach [@Franca, @DePalma2018], this is the most extensive source of data on pollinator populations currently available. For example, in Europe, researchers have recently estimated bee richness declines for every country using predictions generated from models using pollinator associations to different land uses [@DePalma2017]. A second promising method is assessing data collected in pollinator monitoring programs, which are often driven by citizen scientists. This approach was inspired by successful butterfly monitoring programs [@vanSwaay] and is currently being extended to other pollinator taxa. However, these programs require significant time to generate long-term datasets and cannot reveal anything about historic pollinator populations. Finally, the most practical approach for assessing long-term pollinator population trends is to use the available historical information on species occurrences deposited in museum specimen collection data [e.g. @bartomeus2013]. 
